...
public class Item {
	...
	public static void examineJi() {
		if (Room.getObjects().contains(Item.ji) || Player.inventory.contains(Item.ji) || (World.jiInSafe && World.shrineRoom1SafeOpen && Player.getLocation().title.equals("Shrine Room 1"))) {
			Story.print(ji.desc);
	...
	public static void getMirror() {
		if (Player.getLocation().title.equals("Thatched Hut") || Player.getLocation().title.equals("Master Bedroom") || Player.getLocation().title.equals("Overlook")) {
